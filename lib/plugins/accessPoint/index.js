...
class accessPoint{
    ...
    init(...args){
        ...
        const blueprintObject = HELPER.getFileSystemBluprint();
        ...
        if (!HELPER.destinationFolderExists(parametersValues.rootDirPath).success){
            return HELPER.printSpacedMessage('destination folder ' + parametersValues.rootDirPath + ' not found.')
        }
        ...
        if(HELPER.destinationFolderExists(parametersValues.rootDirPath).success){
            return HELPER.printSpacedMessage("there is a '" + parametersValues.moduleName + "' folder already created in '" + parametersValues.moduleName + "'.")
        }
